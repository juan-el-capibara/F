body: Establece el color de fondo en un verde oscuro (#0D4A3A), utiliza las fuentes Arial, Helvetica o sans-serif, establece el color del texto en blanco y centra el contenido.
